...
7. <section id="cta"> — título, subtítulo e botão CTA CENTRALIZADOS. Os itens de contato (endereço, horário, instagram) devem ser exibidos em lista com ícone + texto ALINHADOS À ESQUERDA, dentro de um container centralizado (max-width:400px; margin:0 auto; text-align:left). Use display:flex; align-items:center; gap:12px para cada item de contato. Use fundo claro (cor light da paleta ou branco) com texto escuro para garantir contraste
