...
2. <section id="hero"> — ${data.heroFotoUrl
  ...
  ${data.headline ? `Use EXATAMENTE esta headline: "${data.headline}"` : 'Headline impactante baseada na dor+resultado'}${data.subheadline ? `. Use EXATAMENTE esta subheadline: "${data.subheadline}"` : ', subheadline abaixo'}. Botão WhatsApp CTA grande. O hero deve conter APENAS: headline, subheadline e botão CTA. PROIBIDO adicionar qualquer bullet, badge, ícone, estatística (anos, clientes, resultados) ou texto extra no hero — esses elementos pertencem somente à seção "sobre". PROIBIDO colocar qualquer texto, badge ou emoji acima da foto ou acima da headline.
